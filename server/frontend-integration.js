/**
 * World Ballets - API Integration
 * 
 * This file demonstrates how to update the frontend data service to use the server API
 * instead of the browser-based scraper.
 * 
 * To use this, replace the content of js/data-service.js with this file after setting up
 * the server and updating the API_BASE_URL.
 */
