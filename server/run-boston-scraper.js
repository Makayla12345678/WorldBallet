/**
 * Script to run the Boston Ballet scraper and save the results to the database
 */
...
// Main function to run the Boston Ballet scraper
(async () => {
  try {
    console.log('Running Boston Ballet scraper...');
    ...
    await saveCompanyInfo('boston', companyInfo);
    ...
    await savePerformances('boston', performances);
    console.log('Performances saved successfully');
    
    console.log('Boston Ballet scraper completed successfully');
    
    // Close database connection
    await mongoose.connection.close();
    console.log('Database connection closed');
  } catch (error) {
    console.error('Error running Boston Ballet scraper:', error);
