/**
 * Script to run the Stuttgart Ballet scraper and save the results to the database
 */
...
// Main function to run the Stuttgart Ballet scraper
(async () => {
  try {
    console.log('Running Stuttgart Ballet scraper...');
    ...
    await saveCompanyInfo('stuttgart', companyInfo);
    ...
    await savePerformances('stuttgart', performances);
    console.log('Performances saved successfully');
    
    console.log('Stuttgart Ballet scraper completed successfully');
    
    // Close database connection
    await mongoose.connection.close();
    console.log('Database connection closed');
  } catch (error) {
    console.error('Error running Stuttgart Ballet scraper:', error);
